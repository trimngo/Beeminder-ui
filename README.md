...
The compact **Export** button in the Commitments heading opens accountability sharing options. It can refresh Beeminder and copy either today’s completed goals with their log messages or a numbered list of every commitment with its slug, description, and target rate. Entries without a comment are identified as having no log message. Keeping the action in the heading preserves vertical space for the goal list.
