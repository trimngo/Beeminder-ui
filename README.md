...
The top of the List view shows the estimated time needed to keep currently due commitments safe today. It multiplies each due, unfinished commitment's configured minutes per unit by its Beeminder quantum; due commitments without a time setting are called out below the total. A live countdown shows the hours, minutes, and seconds remaining until the 9 PM end of the workday in the connected Beeminder timezone, reaching zero after 9 PM. The adjacent lifetime penalty total counts recorded derailments at the app's fixed $5-per-derail estimate.
